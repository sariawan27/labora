...
class PendaftaranController extends BaseController
{
    ...
    public function showPemeriksaan($id = null)
    {
        ...
        $logo = Logo::create(base_url() . '/assets/symfony.png')
            ->setResizeToWidth(50)
        ...
        return view('pages/layout/pendaftaran/pendaftar/show',  ['pemeriksaanData' => $pemeriksaanData, 'pasienData' => $pasienData, 'itemPemeriksaanData' => $itemPemeriksaanDataChunk, 'subPemeriksaanData' => $subPemeriksaanDataChunk, 'qr' => $result->getDataUri()]);
    }
}
