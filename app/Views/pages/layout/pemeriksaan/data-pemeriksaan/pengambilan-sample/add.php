    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header border-bottom">
                <h4 class="card-title">Form Pengambilan Sample</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <form id="atlmForm">
                            ...
                            <div class="modal-footer">
                                <a href="/pemeriksaan/pendaftar" type="button" class="btn btn-secondary">Cancel</a>
    ...
    const doSubmit = () => {
        ...
        if (idSubPemeriksaan && item && satuan && nilai) {
            ...
            Swal.fire({
                ...
                text: "Anda akan menambahkan sample pemeriksaan!",
                showCancelButton: true,
            }).then((r) => {
                if (r.isConfirmed) {
                    $.ajax({
                        url: "<?php echo site_url('sampling/pendaftar/add-pengambilan-sample') ?>/<?= $segment ?>",
                        data: data,
                        type: 'POST',
                        success: function(response) {
                            ...
                            return Swal.fire({
                                ...
                                window.location = "<?php echo site_url('/sampling/pendaftar/show') ?>/<?= $uri->getSegment(4) ?>/<?= $uri->getSegment(5) ?>"
                            })
                        },
