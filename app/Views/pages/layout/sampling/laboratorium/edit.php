                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input name="namaLengkap" id="namaLengkap" class="form-control" type="text" placeholder="Nama Lengkap" value="<?= $namaLengkap ?>">
                                            </div>
                                            <div class="form-group mb-2">
                                                <label class="control-label">Tanggal Lahir</label>
                                                <input name="tglLahir" id="tglLahir" class="form-control" type="date" placeholder="Tanggal Lahir" value="<?= $tglLahir ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                <label class="control-label">NIK</label>
                                                <input name="nik" id="nik" class="form-control" type="text" placeholder="NIK" value="<?= $nik ?>">
                                            </div>
                                            <div class="form-group mb-2">
                                                <label class="control-label">Tanggal Tugas</label>
                                                <input name="tglTugas" id="tglTugas" class="form-control" type="date" placeholder="Tanggal Tugas" value="<?= $tglTugas ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    const doSubmit = () => {
        ...
        if (namaLengkap && tglLahir && tglTugas && nik) {
            ...
            Swal.fire({
                icon: 'question',
                title: "Are you sure?",
                text: "This action will be modify petugas data!",
